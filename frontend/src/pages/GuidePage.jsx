...
import { Check, ChevronRight, CreditCard, Headphones, KeyRound, Search, ShieldCheck, ShoppingCart } from 'lucide-react';
...
const guideSteps = [
  ...
  [CreditCard, 'Thanh toán', 'Tạo đơn và chuyển khoản đúng nội dung hiển thị.'],
  [KeyRound, 'Nhận thông tin', 'Theo dõi trạng thái và xem bàn giao trong tài khoản khách hàng.'],
];
      ...
      <section className="section"><div className="container">
        ...
        <div className="guide-layout">
          <main className="guide-content">
            ...
            <section><h2>Sau khi thanh toán</h2><p>Đơn hàng chuyển sang trạng thái chờ xác nhận. Khi thanh toán được kiểm tra, hệ thống bắt đầu xử lý và bàn giao tài khoản hoặc mã kích hoạt.</p><div className="guide-status-flow"><span>Chờ thanh toán</span><i>→</i><span>Chờ xác nhận</span><i>→</i><span>Đang xử lý</span><i>→</i><span>Hoàn thành</span></div></section>
          ...
          <aside className="guide-support-card"><span><Headphones /></span><h2>Vẫn cần hỗ trợ?</h2><p>Đội ngũ Hải Premium hoạt động từ 08:00 đến 23:00 mỗi ngày.</p><a className="button button--primary button--block" href="mailto:support@haipremium.vn">Gửi email hỗ trợ</a><Link className="button button--ghost button--block" to="/products">Xem sản phẩm</Link></aside>
        </div>
      </div></section>
    </div>
  );
